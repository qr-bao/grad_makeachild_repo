...
from predpreygrass.rllib.env3.predpreygrass_rllib_env123.predpreygrass_rllib_env import (
    PredPreyGrass,
)
from predpreygrass.rllib.env3.predpreygrass_rllib_env123.visualizer import (
    PredPreyVisualizer,
)
...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Optional directory to store rendered frames as PNG files.",
    )
    parser.add_argument(
        "--record-every-n-frames",
        type=int,
        default=1,
        help="Save one frame every N renders when --record-dir is set (default: 1).",
    )
    return parser
...
def main() -> None:
    ...
    visualizer = PredPreyVisualizer(
        env,
        fps=args.fps,
        record_dir=args.record_dir,
        record_frame_interval=args.record_every_n_frames,
    )
    step_count = 0
