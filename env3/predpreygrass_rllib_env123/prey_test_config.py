...
prey_test_config = {
    ...
    # ============================================================
    # --- 基础数量 ---
    'initial_num_grass': 80,  # 初始草数量

    # --- 能量系统 ---
    'initial_energy_grass': 12.0,  # 初始/重生能量
    'energy_gain_per_step_grass': 1,  # 基础增长速率（↑加快整体增长）
    'grass_energy_decay_constant': 10.0,  # 能量衰减常数（↑能量上限更高）

    # --- 繁殖基本条件 ---
    'enable_grass_reproduction': True,  # 是否启用繁殖
    'grass_reproduction_age': 80,  # 最小繁殖年龄（↓加快初期爆发）
    'grass_reproduction_energy_threshold': 10.0,  # 繁殖能量门槛（↓更快满足条件）
    'grass_reproduction_cooldown': 60,  # 繁殖冷却时间/步（↓繁殖更频繁）
    ...
    # --- 死亡与重生 ---
    'grass_respawn_delay': 600,  # 被吃后延迟重生/步（↑被吃区域更久空旷）
    # ============================================================
    # 🔋 能量系统 - 软限制配置
    # ============================================================
    # === PREDATOR:无敌设置 ===
    ...
    'prey_creation_energy_threshold': 90.0,
