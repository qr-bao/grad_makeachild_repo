#!/usr/bin/env python3
"""
MAPPO-style launcher (using PPO with multi-agent setup and shared hyperparams).

Note: RLlib 不自带“原生 MAPPO”类，这里采用 PPOConfig 的多智能体配置
（集中 critic 需自定义模型，这里使用默认 MLP 作近似基线）。
"""
...
def main() -> int:
    ...
    config = (
        ...
        .training(
            ...
            minibatch_size=args.minibatch_size,  # Ray 2.50 uses minibatch_size
