...
LOG_BASE="${PROJECT_ROOT}/src/predpreygrass/rllib/env3/predpreygrass_rllib_env129/logs"
...
from predpreygrass.rllib.env3.predpreygrass_rllib_env129.prey_test_config import prey_test_config
...
cd "${PROJECT_ROOT}"
python "${PROJECT_ROOT}/src/predpreygrass/rllib/env3/predpreygrass_rllib_env129/train_simple.py" \
